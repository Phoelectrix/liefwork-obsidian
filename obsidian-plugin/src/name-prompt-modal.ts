    ...
    const modal = new (class extends Modal {
      ...
      onOpen() {
        ...
        new Setting(this.contentEl)
          ...
          // setWarning, not setDestructive: the replacement is @since 1.13.0 and
          // minAppVersion is 1.8.7 — calling it on an older app throws. Same
          // floor as the settings tab's display() fallback (scan recommendation,
          // deliberate; revisit when the floor rises to 1.13).
