...
1. **Point the agent at the folder** and let it run the Charter's start ritual — read the root roll-up, then the branch you're working on. That is the whole briefing.
