...
// Camera framing (Task 8): three previously-hardcoded constants — fit padding,
// meristem-click pad, and branch-frame pad — become house-style-tuneable via
// StylingConfig.camera. The single most important property here is that the
